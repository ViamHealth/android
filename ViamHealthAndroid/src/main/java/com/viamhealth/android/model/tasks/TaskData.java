 ...
 */
public class TaskData implements Parcelable, Task {
    String id;
    String message;
    String labelChoice1;
    String labelChoice2;
    ...
    Integer weight = 0;
    final Integer taskType = TaskItemType.SimpleText.value();
    final Integer adapterType = TaskAdapterType.SimpleText.value();
