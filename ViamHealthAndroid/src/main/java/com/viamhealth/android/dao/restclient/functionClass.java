...
public class functionClass {
	...
	public ArrayList<FamilyData> GetFamilyMember(String username) {
			 ...
			 jarray = jObject.getJSONArray("rs");
			   appPrefs.setMenuList("");
				 for (int i = 0; i < jarray.length(); i++) {
					 ...
					 lstFamily.add(new FamilyData(c.getString("id").toString(), 
							 					  c.getString("username").toString(),
							 					  c.getString("email").toString(),
							 					  c.getString("first_name").toString(),
							 					  c.getString("last_name").toString(),
							 					  c.getJSONObject("profile").getString("profile_picture_url").toString()));
				 }
	...
	// function for get family member list
	public ArrayList<FamilyData> GetUserProfile(String id) {
		ArrayList<FamilyData> lstFamily = new ArrayList<FamilyData>();
		
		String	responsetxt="1";
		String baseurlString = Global_Application.url+"users/?user="+id;    
		Log.e("TAG","url is : " + baseurlString);
	...
	public String addProfile(String fn,String ln,String gender,String dob,String height,String weight,String email,String phonenum) {
		String	responsetxt="1";
		String baseurlString = Global_Application.url+"addprofile.cgi";    
		Log.e("TAG","url is : " + baseurlString);
		
		RestClient client = new RestClient(baseurlString);   
		client.AddParam("fn",fn);
	    client.AddParam("ln",ln);
	    client.AddParam("gender",gender);
	    client.AddParam("dob",dob);
	    client.AddParam("height",height);
	    client.AddParam("weight",weight);
	    client.AddParam("email",email);
	    client.AddParam("phonenum",phonenum);
	    client.AddParam("token",appPrefs.getToken().toString());
	    client.AddParam("resp","JSON");
