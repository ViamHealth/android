 ...
 */
public class NotifyMedicineThreeNight  extends IntentService {
    public NotifyMedicineThreeNight(){
    ...
    private static int NOTIFICATION = 34;
    private final static Class selfClass = NotifyMedicineThreeNight.class;
