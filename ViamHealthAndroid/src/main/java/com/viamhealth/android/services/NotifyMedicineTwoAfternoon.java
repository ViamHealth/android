 ...
 */
public class NotifyMedicineTwoAfternoon  extends IntentService {
    public NotifyMedicineTwoAfternoon(){
    ...
    private static int NOTIFICATION = 23;
    private final static Class selfClass = NotifyMedicineTwoAfternoon.class;
