 ...
 */
public class NotifyMedicineTwoNight  extends IntentService {
    public NotifyMedicineTwoNight(){
    ...
    private static int NOTIFICATION = 24;
    private final static Class selfClass = NotifyMedicineTwoNight.class;
