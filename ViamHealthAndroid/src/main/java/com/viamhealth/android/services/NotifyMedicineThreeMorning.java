 ...
 */
public class NotifyMedicineThreeMorning  extends IntentService {
    public NotifyMedicineThreeMorning(){
    ...
    private static int NOTIFICATION = 32;
    private final static Class selfClass = NotifyMedicineThreeMorning.class;
