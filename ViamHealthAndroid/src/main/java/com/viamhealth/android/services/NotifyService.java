...
public class NotifyService extends Service {
    ...
    private void showNotification(NotificationType type, User user, List<NotificationObject> notifyObjects) {

        NotificationHandler handler = NotifyHandlerFactory.getHandler(type, this);
        Notification notification = handler.getNotification(user, notifyObjects);
