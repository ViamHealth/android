...
public class NotifyMedicineTomorrowAfternoon extends IntentService {
    public NotifyMedicineTomorrowAfternoon(){
    ...
    private static int NOTIFICATION = 13;
    private final static Class selfClass = NotifyMedicineTomorrowAfternoon.class;
