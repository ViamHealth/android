 ...
 */
public class NotifyMedicineTodayAfternoon extends IntentService{
    public NotifyMedicineTodayAfternoon(){
    ...
    private final static Class selfClass = NotifyMedicineTodayAfternoon.class;
