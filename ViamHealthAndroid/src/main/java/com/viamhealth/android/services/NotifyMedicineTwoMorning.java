 ...
 */
public class NotifyMedicineTwoMorning  extends IntentService {
    public NotifyMedicineTwoMorning(){
    ...
    private static int NOTIFICATION = 22;
    private final static Class selfClass = NotifyMedicineTwoMorning.class;
