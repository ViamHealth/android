 ...
 */
public class NotifyMedicineTomorrowMorning extends IntentService{
    public NotifyMedicineTomorrowMorning(){
    ...
    private static int NOTIFICATION = 12;
    private final static Class selfClass = NotifyMedicineTomorrowMorning.class;
