...
import com.viamhealth.android.ui.helper.FontUtils;
import com.viamhealth.android.ui.helper.ToggleImageLabeledButton;
 ...
 */
public class AccordinLayout extends LinearLayout {
    ...
    public AccordinLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private View getView(final LayoutInflater inflater, int i, boolean hide) {
        ...
        FontUtils.setCustomFont(container, AccordinLayout.this.getContext().getAssets());
    ...
    private View getViewHeader(LayoutInflater inflater, final int position, boolean hide) {
        ...
        FontUtils.setCustomFont(view, AccordinLayout.this.getContext().getAssets());
